                            ...
                            <div class="card-body">
                                <form action="create-user.php"method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="radio" class="form-check-input" id="Laki-laki" value="Laki-laki" name="gender">
                                        <label for="Laki-laki" class="form-check-label">Laki-laki</label>
                                    </div>
                                    <div class="mb-3">
                                        <label class="formm-label d-block">Gender</label>
                                        <input type="radio" class="form-check-input" id="Perempuan" value="Perempuan" name="gender">
