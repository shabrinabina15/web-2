                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="edit-user.php?id=<?= $user['id'] ?>" method="POST">
                                    <div class="mb-3">
                                        <label for="firstname" class="formm-label">First Name</label>
                                        <input type="text" class="form-control" id="firstname" name="firstname" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="lastname" class="formm-label">Last Name</label>
                                        <input type="text" class="form-control" id="lastname" name="lastname" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="formm-label d-block">Gender</label>
                                        <input type="radio" class="form-check-input" id="Laki-laki" value="Laki-laki" name="gender" <?= $user['gender'] === 'Laki=laki' ? 'cheked' : ''?>>
                                        <label for="Laki-laki" class="form-check-label">Laki-laki</label>
                                    </div>
                                    <div class="mb-3">
                                        <label class="formm-label d-block">Gender</label>
                                        <input type="radio" class="form-check-input" id="Perempuan" value="Perempuan" name="gender" <?= $user['gender'] === 'Perempuan' ? 'cheked' : ''?>>
                                        <label for="Perempuan" class="form-check-label">Perempuan</label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="age" class="formm-label">Age</label>
                                        <input type="number" class="form-control" id="age" name="age" min="0" max="100" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="weight" class="formm-label">Weight</label>
